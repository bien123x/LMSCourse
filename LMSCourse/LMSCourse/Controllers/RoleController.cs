...
namespace LMSCourse.Controllers
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        [Authorize(Policy = PERMISSION.System.UserManagement.Roles.Module)]
        ...
        [Authorize(Policy = PERMISSION.System.UserManagement.Roles.Create)]
        ...
        [Authorize(Policy = PERMISSION.System.UserManagement.Roles.Edit)]
        ...
        [Authorize(Policy = PERMISSION.System.UserManagement.Roles.ChangePermissions)]
        ...
        [Authorize(Policy = PERMISSION.System.UserManagement.Roles.Delete)]
